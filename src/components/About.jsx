    ...
    <div className="max-w-[90vw] mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-16">
      ...
      <section className="mb-12 sm:mb-16 md:mb-20">
        <div className="flex items-center justify-between mb-8">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-gray-500">{timeline.subtitle}</p>
        ...
        <div className="space-y-6">
          {timeline.items.map((item, index) => (
            <article key={index} className="p-6 rounded-2xl border border-gray-200 card-hover">
              <p className="text-xs text-gray-400 uppercase tracking-[0.35em] mb-2">{item.period}</p>
      ...
      <section className="mb-12 sm:mb-16 md:mb-20">
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-gray-500 mb-3">{values.subtitle}</p>
            ...
            <ul className="space-y-6 text-gray-700 leading-relaxed">
              {values.items.map((item, index) => (
                <li key={index} className="flex flex-col sm:block">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-3xl p-8 card-hover">
            <p className="text-sm text-pink-500 font-semibold tracking-[0.35em] mb-4">{values.product.subtitle}</p>
      ...
      <section className="mb-12 sm:mb-16 md:mb-20">
        <div className="bg-black text-white rounded-3xl p-10 md:p-14 card-hover">
          <p className="uppercase text-sm tracking-[0.4em] text-gray-300 mb-4">{philosophy.subtitle}</p>
